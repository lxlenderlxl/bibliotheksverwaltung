...
public class WarenKorbHinzuActionListener implements ActionListener
{
	private BibliotheksVerwalter verwalter = null;
	private Exemplar exemplar = null;

	public WarenKorbHinzuActionListener(BibliotheksVerwalter derVerwalter, Exemplar dasExemplar)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (!verwalter.holeUpdateInfo().holeUpdateSperre())
		{
			...
			//Ohne BuchKiste
			verwalter.getWarenKorbVerwalter().fuegeExemplarHinzu(exemplar);
